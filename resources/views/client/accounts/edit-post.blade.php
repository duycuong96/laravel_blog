            ...
            <div class="col-md-4">
                <div class="post-content">
                    ...
                    <img width="100px" style="border-radius:50%"
                        src="{{ asset(auth()->user()->avatar ? 'storage/'.auth()->user()->avatar :'') }}" alt="">
                    <form action="{{ route('client.account.update', auth()->user()->id) }}" method="post"
            ...
            <div class="col-md-8">
                <div class="post-content" style="text-align:left">
                    ...
                    <div class="row" style="padding:20px">
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('client.my-posts.update', [$post->id]) }}"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="card-body">
